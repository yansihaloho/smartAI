...
export const predictionsTable = pgTable("predictions", {
  ...
  bbfs7: text("bbfs7").array().notNull().default([]),
...
export const predictionAccuracyTable = pgTable("prediction_accuracy", {
  ...
  predictedBbfs5: text("predicted_bbfs5").array().notNull().default([]),
  predictedBbfs6: text("predicted_bbfs6").array().notNull(),
  predictedBbfs7: text("predicted_bbfs7").array().notNull().default([]),
  ...
  hitBbfs5: boolean("hit_bbfs5").default(false),
  hitBbfs6: boolean("hit_bbfs6"),
  hitBbfs7: boolean("hit_bbfs7").default(false),
...
export const missAnalysisTable = pgTable("miss_analysis", {
  ...
  bbfs5: text("bbfs5").array().notNull().default([]),
  bbfs6: text("bbfs6").array().notNull().default([]),
  bbfs7: text("bbfs7").array().notNull().default([]),
  ...
  hitBbfs5: boolean("hit_bbfs5").notNull().default(false),
  hitBbfs6: boolean("hit_bbfs6").notNull().default(false),
  hitBbfs7: boolean("hit_bbfs7").notNull().default(false),
